...
public class MainActivity extends AppCompatActivity {
    ...
    private class DownloadUpdate extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... strings) {
            String stringUrl = "http://api.openweathermap.org/data/2.5/forecast?id=1814905&APPID=347b636353172a890662cccbad5447b1&lang=zh_cn&units=metric";
        ...
        protected void onPostExecute(String temperature) {
            ...
            Toast.makeText(MainActivity.this, "The weather is refreashed", Toast.LENGTH_SHORT).show();
